	        ...
	        <div class="left">
	            ...
	            <div class="item2" id="slect">
	                ...
	                <div class="program1 border-bottom">
	                    ...
	                    <p>由<strong><#if supplier??><#if supplier.uid gt 1><a href="${app.basePath}/seller/item${supplier.uid!'0'}" title="查看店家">${supplier.pname!''}</a><#else><a href="javascript:;">${supplier.pname!''}</a></#if></#if></strong> 发货并负责售后服务。</p>
