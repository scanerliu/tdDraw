		    ...
		    <div class="goodsorder_detail">
		      <div class="fl goodsorder_detail_left w590">
		        <dl class="fl">
		          ...
		          <dd class="dd2 w80 txtc fl" style="padding:0;line-height:100px;">${product.price!'0'}</dd>
		          <dd class="dd3 w80 txtc fl" style="padding:0;line-height:100px;">${product.currPrice!'0'}</dd>
		          <dd class="dd4 w90 txtc fl" style="padding:0;line-height:100px;">${product.basePrice!'0'}</dd>
		        </dl>
		      </div>
		      <div class="div5 w118 fl" style="line-height:100px;">${product.bond!'0'}</div>
		      <div class="div6 w108 fl" style="line-height:100px;">
		      	${product.joinStatusStr!''}
		      </div>
		      <div class="div7 w89 fl">
		        <#if product.onshelf><#else><P><a href="javascript:;" onclick="editProduct(${product.id?c})" title="" class="a_sure2" style="margin-top:20px;">商品编辑</a></P></#if>
